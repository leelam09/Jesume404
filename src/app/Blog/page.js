  ...
  return (
    ...
    <div className='h-auto w-full p-5'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">RESUME ADVICE</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">What Recruiters Look For in an AI-Scanned Resume</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 3/5/2025 • Updated: 4/20/2025</p>
            <p className="text-sm text-gray-600">10 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">RESUME ADVICE</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">Best Resume Formats for AI Parsing</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 2/28/2025 • Updated: 4/12/2025</p>
            <p className="text-sm text-gray-600">5 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">RESUME ADVICE</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">Avoid These Mistakes When Using AI to Write Resumes</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 2/10/2025 • Updated: 3/25/2025</p>
            <p className="text-sm text-gray-600">6 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">RESUME ADVICE</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">Can AI Really Replace a Resume Writer?</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 1/20/2025 • Updated: 3/5/2025</p>
            <p className="text-sm text-gray-600">7 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">RESUME ADVICE</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">AI vs Human: Who Writes the Better Resume?</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 1/5/2025 • Updated: 2/10/2025</p>
            <p className="text-sm text-gray-600">8 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">COVER LETTER HELP</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">How to Write a Cover Letter That Gets Noticed</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 4/10/2025 • Updated: 5/12/2025</p>
            <p className="text-sm text-gray-600">6 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">COVER LETTER HELP</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">ChatGPT Cover Letter Tips for Tech Jobs</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 3/28/2025 • Updated: 5/1/2025</p>
            <p className="text-sm text-gray-600">7 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">COVER LETTER HELP</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">Mistakes to Avoid in Your AI-Written Cover Letter</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 3/10/2025 • Updated: 4/22/2025</p>
            <p className="text-sm text-gray-600">8 min read</p>
            </div>

            <div className="group border-t-4 border-red-600 p-6 bg-white shadow-md rounded-lg hover:shadow-xl transition hover:scale-[1.01] cursor-pointer">
            <p className="text-xs text-red-600 font-semibold mb-2">COVER LETTER HELP</p>
            <h3 className="text-lg font-bold text-black group-hover:text-red-700 mb-2">Cover Letter vs Resume: Key Differences</h3>
            <p className="text-sm text-gray-700 mb-3">Published: 2/20/2025 • Updated: 4/2/2025</p>
            <p className="text-sm text-gray-600">5 min read</p>
            </div>
