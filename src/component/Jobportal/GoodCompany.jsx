        ...
        <div className="mb-16 sm:mb-20 md:mb-24">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {workLifeStats.map((stat, index) => (
              <div
                key={index}
                className="group relative bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 text-center hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-500 cursor-pointer overflow-hidden"
              >
        ...
        <div className="mb-16 sm:mb-20 md:mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
            {[
              ...
              <div
                key={index}
                className="group relative bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-500 overflow-hidden"
              >
                {/* Gradient background on hover */}
                <div
