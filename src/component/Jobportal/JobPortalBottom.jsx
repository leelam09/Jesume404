          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <ul className="space-y-4 mb-10 text-left max-w-2xl">
              <li className="flex items-start">
                ...
                <span>
                  <span className="font-semibold">
                    Professional out-of-the-box resumes
                  </span>
                  , instantly generated by the most advanced resume builder
              ...
              <li className="flex items-start">
                <span className="text-red-600 mr-2 mt-1">•</span>
                <span>
                  <span className="font-semibold">Effortless crafting</span>{" "}
                  Real-time preview & pre-written resume examples.
                  <br />
              ...
              <li className="flex items-start">
                <span className="text-red-600 mr-2 mt-1">•</span>
                <span>
                  <span className="font-semibold">Land your dream job</span>{" "}
                  with the perfect resume employers are looking for.
                </span>
              </li>
            </ul>
            ...
            <div className="flex justify-center lg:justify-start space-x-4">
              {[1, 2, 3].map((item) => (
                <div
                  key={item}
                  className="w-16 h-1 bg-gradient-to-r from-red-600 to-black rounded-full"
                ></div>
              ))}
            </div>
          </div>
